               ...
               <table className="w-full table-auto">
                  <thead className="h-12 bg-gray-300 font-mono text-sm">
                     <tr>
                        ...
                        <th className="text-left px-2 w-[30%]">Tiêu đề bài viết</th>

                        <th className="text-left px-2">Người tạo</th>
                        <th className="text-left px-2">Ngày tạo</th>
                  ...
                  <tbody className="bg-white text-sm ">
                     <tr className="h-12 border-b">
                        ...
                        <td className="px-2" >Tiêu đề bài viết</td>
                        <td className="px-2">Nguyễn Văn Nam</td>
                        <td className="px-2">12/10/2024 11:20:20</td>
